    ...
    switch(show){
      case "nav_grafic":
        for (i = 0; i < document.getElementsByClassName("main-nv").length; i++) {
           if (i === 0 & document.body.clientWidth > 1410) {
      ...
      case "nav_trans":
        for (i = 0; i < document.getElementsByClassName("main-nv").length; i++) {
            if (i === 1 & document.body.clientWidth > 1410) {
                document.getElementsByClassName("main-nv")[i].style.display ="block";
      ...
      case "nav_anim":
        for (i = 0; i < document.getElementsByClassName("main-nv").length; i++) {
            if (i === 2 & document.body.clientWidth > 1410) {
                document.getElementsByClassName("main-nv")[i].style.display ="block";
      ...
      case "nav_digit":
        for (i = 0; i < document.getElementsByClassName("main-nv").length; i++) {
            if (i === 3 & document.body.clientWidth > 1410) {
                document.getElementsByClassName("main-nv")[i].style.display ="block";
      ...
      case "nav_music":
        for (i = 0; i < document.getElementsByClassName("main-nv").length; i++) {
            if (i === 4 & document.body.clientWidth > 1410) {
                document.getElementsByClassName("main-nv")[i].style.display ="block";
      ...
      case "nav_tech":
        for (i = 0; i < document.getElementsByClassName("main-nv").length; i++) {
            if (i === 5 & document.body.clientWidth > 1410) {
                document.getElementsByClassName("main-nv")[i].style.display ="block";
      ...
      case "nav_data":
        for (i = 0; i < document.getElementsByClassName("main-nv").length; i++) {
            if (i === 6 & document.body.clientWidth > 1410) {
                document.getElementsByClassName("main-nv")[i].style.display ="block";
      ...
      case "nav_busines":
        for (i = 0; i < document.getElementsByClassName("main-nv").length; i++) {
            if (i === 7 & document.body.clientWidth > 1410) {
                document.getElementsByClassName("main-nv")[i].style.display ="block";
      ...
      case "nav_life":
        for (i = 0; i < document.getElementsByClassName("main-nv").length; i++) {
            if (i === 8 & document.body.clientWidth > 1410) {
                document.getElementsByClassName("main-nv")[i].style.display ="block";
